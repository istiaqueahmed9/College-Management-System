...
session_start();
if(empty($_SESSION)){
	header('Location: http://localhost/My Project/Project/students/login.php');
    exit();
}
		            ...
		            <div class="card-header bg-info text-white align-items-end">
		              <div class="row justify-content-between">
		                    ...
		                    <div class="d-inline-block mr-2">
		                      <a class=" text-white" style="text-decoration:none;" href="http://localhost/My Project/Project/students/pdf.php?sId=<?php echo $sId; ?>">
